...
public class SoundBoardGUIScreen extends AbstractContainerScreen<SoundBoardGUIMenu> {
	...
	ImageButton imagebutton_legendary_finie;
	ImageButton imagebutton_legendary_finie1;
	ImageButton imagebutton_legendary_finie2;
	...
	public void init() {
		...
		imagebutton_legendary_finie = new ImageButton(this.leftPos + 71, this.topPos + 130, 26, 26, 0, 0, 26, new ResourceLocation("bals_arystisa:textures/screens/atlas/imagebutton_legendary_finie.png"), 26, 52, e -> {
			if (true) {
				BalsArystisaMod.PACKET_HANDLER.sendToServer(new SoundBoardGUIButtonMessage(14, x, y, z));
				SoundBoardGUIButtonMessage.handleButtonAction(entity, 14, x, y, z);
			}
		});
		guistate.put("button:imagebutton_legendary_finie", imagebutton_legendary_finie);
		this.addRenderableWidget(imagebutton_legendary_finie);
		imagebutton_legendary_finie1 = new ImageButton(this.leftPos + 101, this.topPos + 130, 26, 26, 0, 0, 26, new ResourceLocation("bals_arystisa:textures/screens/atlas/imagebutton_legendary_finie1.png"), 26, 52, e -> {
			if (true) {
				BalsArystisaMod.PACKET_HANDLER.sendToServer(new SoundBoardGUIButtonMessage(15, x, y, z));
				SoundBoardGUIButtonMessage.handleButtonAction(entity, 15, x, y, z);
			}
		});
		guistate.put("button:imagebutton_legendary_finie1", imagebutton_legendary_finie1);
		this.addRenderableWidget(imagebutton_legendary_finie1);
		imagebutton_legendary_finie2 = new ImageButton(this.leftPos + 131, this.topPos + 130, 26, 26, 0, 0, 26, new ResourceLocation("bals_arystisa:textures/screens/atlas/imagebutton_legendary_finie2.png"), 26, 52, e -> {
			if (true) {
				BalsArystisaMod.PACKET_HANDLER.sendToServer(new SoundBoardGUIButtonMessage(16, x, y, z));
				SoundBoardGUIButtonMessage.handleButtonAction(entity, 16, x, y, z);
			}
		});
		guistate.put("button:imagebutton_legendary_finie2", imagebutton_legendary_finie2);
		this.addRenderableWidget(imagebutton_legendary_finie2);
	}
}
