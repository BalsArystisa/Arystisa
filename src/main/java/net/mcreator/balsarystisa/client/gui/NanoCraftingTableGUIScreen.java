...
public class NanoCraftingTableGUIScreen extends AbstractContainerScreen<NanoCraftingTableGUIMenu> {
	...
	public NanoCraftingTableGUIScreen(NanoCraftingTableGUIMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("bals_arystisa:textures/screens/nano_crafting_table_gui.png");
