...
public class CombinateurScreen extends AbstractContainerScreen<CombinateurMenu> {
	private final static HashMap<String, Object> guistate = CombinateurMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public CombinateurScreen(CombinateurMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("bals_arystisa:textures/screens/combinateur.png");
