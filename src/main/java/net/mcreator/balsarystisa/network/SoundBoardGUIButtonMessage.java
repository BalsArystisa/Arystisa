...
import net.mcreator.balsarystisa.procedures.ThirdLegendarySoundboardProcedProcedure;
...
import net.mcreator.balsarystisa.procedures.SecondLegendarySoundboardProcedProcedure;
...
import net.mcreator.balsarystisa.procedures.FirstLegendarySoundboardProcedProcedure;
...
public class SoundBoardGUIButtonMessage {
	...
	public static void handleButtonAction(Player entity, int buttonID, int x, int y, int z) {
		...
		if (buttonID == 14) {
			...
			FirstLegendarySoundboardProcedProcedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 15) {

			SecondLegendarySoundboardProcedProcedure.execute(world, x, y, z, entity);
		}
		if (buttonID == 16) {

			ThirdLegendarySoundboardProcedProcedure.execute(world, x, y, z, entity);
		}
	}
