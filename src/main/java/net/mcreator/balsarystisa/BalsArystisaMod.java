 ...
 *
 */
package net.mcreator.balsarystisa;
...
@Mod("bals_arystisa")
public class BalsArystisaMod {
	public static final Logger LOGGER = LogManager.getLogger(BalsArystisaMod.class);
	public static final String MODID = "bals_arystisa";

	public BalsArystisaMod() {
		MinecraftForge.EVENT_BUS.register(this);
		IEventBus bus = FMLJavaModLoadingContext.get().getModEventBus();
		BalsArystisaModSounds.REGISTRY.register(bus);
