...
public class BalsArystisaModSounds {
	...
	public static final RegistryObject<SoundEvent> CHIPI_CHAPA_SOUNDBOARD = REGISTRY.register("chipi-chapa-soundboard", () -> SoundEvent.createVariableRangeEvent(new ResourceLocation("bals_arystisa", "chipi-chapa-soundboard")));
}
