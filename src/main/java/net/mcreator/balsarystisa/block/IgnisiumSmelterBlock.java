...
public class IgnisiumSmelterBlock extends Block {
	public IgnisiumSmelterBlock() {
	...
	public List<ItemStack> getDrops(BlockState state, LootParams.Builder builder) {
		...
		return Collections.singletonList(new ItemStack(BalsArystisaModBlocks.IGNISIUM_SMELTER.get()));
	}
}
