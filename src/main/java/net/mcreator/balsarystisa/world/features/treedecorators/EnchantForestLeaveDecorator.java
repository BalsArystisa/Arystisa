...
public class EnchantForestLeaveDecorator extends LeaveVineDecorator {
	...
	public static void registerPointOfInterest(RegisterEvent event) {
		event.register(ForgeRegistries.Keys.TREE_DECORATOR_TYPES, registerHelper -> registerHelper.register("enchant_forest_tree_leave_decorator", DECORATOR_TYPE));
	}

	public EnchantForestLeaveDecorator() {
		super(0.25f);
	}
