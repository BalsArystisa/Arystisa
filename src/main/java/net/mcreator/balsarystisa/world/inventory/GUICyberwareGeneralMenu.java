...
import net.mcreator.balsarystisa.procedures.GUI_Cyberware_General_UIProcedure;
...
public class GUICyberwareGeneralMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public GUICyberwareGeneralMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof GUICyberwareGeneralMenu) {
			Level world = entity.level();
			double x = entity.getX();
			double y = entity.getY();
			double z = entity.getZ();
			GUI_Cyberware_General_UIProcedure.execute(entity);
		}
	}
}
