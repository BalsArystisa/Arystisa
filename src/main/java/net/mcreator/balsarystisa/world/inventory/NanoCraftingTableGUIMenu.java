...
import net.mcreator.balsarystisa.procedures.NanoCraftTableCraftProcedProcedure;
...
public class NanoCraftingTableGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof NanoCraftingTableGUIMenu) {
			Level world = entity.level();
			double x = entity.getX();
			double y = entity.getY();
			double z = entity.getZ();
			NanoCraftTableCraftProcedProcedure.execute(entity);
		}
	}
}
