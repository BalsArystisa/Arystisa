...
if (==true&&==true) {armor = new java.text.DecimalFormat("##.##").format((entity instanceof LivingEntity _livEnt ? _livEnt.getArmorValue():0)+5);armor_command = "attribute @s minecraft:generic.armor".replace("(armor)",armor);{
Entity _ent = entity;
