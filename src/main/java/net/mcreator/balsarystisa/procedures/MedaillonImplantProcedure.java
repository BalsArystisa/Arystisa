...
public class MedaillonImplantProcedure {
	public static void execute(LevelAccessor world, Entity entity) {
		...
		if (BalsArystisaModItems.DELETED_MOD_ELEMENT.get() == (entity instanceof LivingEntity _livEnt ? _livEnt.getMainHandItem() : ItemStack.EMPTY).getItem()
				&& (entity.getCapability(BalsArystisaModVariables.PLAYER_VARIABLES_CAPABILITY, null).orElse(new BalsArystisaModVariables.PlayerVariables())).Invisible_Camo == false) {
			if (world.isClientSide())
				Minecraft.getInstance().gameRenderer.displayItemActivation(new ItemStack(BalsArystisaModItems.DELETED_MOD_ELEMENT.get()));
			if (entity instanceof Player _player) {
